            ...
            <section className="section-inner">
              <div className="content-inner">
                ...
                <p className="subheading">
                  With Divergent AG, you can get real-time analytics tailored to
                  your farm's specific location to help in maximising your
                  yield.
                </p>
                <div className="button-wrapper">
                  <a href="/accounts/signup/" className="button-primary">
                    <div className="button-primary--overlay">
                      <div>Get started for free</div>
                      <div className="button-primary--icon">
                        <svg
                          width="12"
                          height="12"
                          viewBox="0 0 12 12"
                  ...
                  <link rel="prefetch" href="/accounts/signup/" />
                </div>
              </div>
