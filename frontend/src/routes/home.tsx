          ...
          <section className="section-inner">
            <div className="content-inner">
              <h1 className="headline">
                ...
                <span>
                  dominate
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1418 125" fill="currentColor">
              ...
              <p className="subheading">
                With Divergent AG, you can get real-time analytics tailored to your farm's specific location to help in maximising your yield.
              </p>
            </div>
